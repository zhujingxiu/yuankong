...
$_['entry_order_status']         = '订单初始状态：<br /><span class="help">设置默认订单状态的命令时处理。</span>';
$_['entry_complete_status']      = '订单完成状态：<br /><span class="help">设置客户订单完结状态。</span>';
$_['entry_paid_status']          = '订单已支付：<br /><span class="help">设置客户订单已支付状态。</span>';
$_['entry_unshipped_status']     = '订单未发货：<br /><span class="help">设置客户订单未发货状态。</span>';
$_['entry_shipped_status']       = '订单已发货：<br /><span class="help">设置客户订单已发货状态。</span>';
$_['entry_received_status']      = '订单已收货：<br /><span class="help">设置客户订单已收货状态。</span>';
$_['entry_refunded_status']      = '订单已退款：<br /><span class="help">设置客户订单已退款状态。</span>';
$_['entry_closed_status']        = '订单已关闭：<br /><span class="help">设置客户订单已关闭状态。</span>';
