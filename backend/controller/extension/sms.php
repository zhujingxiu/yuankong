...
class ControllerExtensionSms extends Controller { 
    ...
    public function index() {
        $this->language->load('extension/sms');
        
        $this->document->setTitle($this->language->get('heading_title'));
         
        $this->load->model('extension/sms');
    ...
    public function insert() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_extension_sms->addCase($this->request->post);
            ...
            $this->redirect($this->url->link('extension/sms', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    ...
    public function update() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_extension_sms->editCase($this->request->get['case_id'], $this->request->post);
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $case_id) {
                $this->model_extension_sms->deleteCase($case_id);
            }
    ...
    protected function getList() {
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('extension/sms', 'token=' . $this->session->data['token'] . $url, 'SSL'),
            'separator' => ' :: '
        );
                            
        $this->data['insert'] = $this->url->link('extension/sms/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $this->data['delete'] = $this->url->link('extension/sms/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');  
        ...
        $case_total = $this->model_extension_sms->getTotalCases();
    
        $results = $this->model_extension_sms->getCases($data);
        ...
        foreach ($results as $result) {
            ...
            $action[] = array(
                ...
                'href' => $this->url->link('extension/sms/update', 'token=' . $this->session->data['token'] . '&case_id=' . $result['case_id'] . $url, 'SSL')
            );
            ...
            $this->data['cases'][] = array(
                ...
                'images'    => $this->model_extension_sms->getTotalCaseImages($result['case_id']),
        ...
        $this->data['sort_name'] = $this->url->link('extension/sms', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
        $this->data['sort_sort_order'] = $this->url->link('extension/sms', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, 'SSL');
        ...
        $pagination->url = $this->url->link('extension/sms', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        ...
        $this->template = 'extension/sms_list.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
    ...
    protected function getForm() {
        ...
        if (!isset($this->request->get['case_id'])) {
            $this->data['action'] = $this->url->link('extension/sms/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
        } else {
            $this->data['action'] = $this->url->link('extension/sms/update', 'token=' . $this->session->data['token'] . '&case_id=' . $this->request->get['case_id'] . $url, 'SSL');
        }
        $this->load->model('tool/image');
        $this->data['cancel'] = $this->url->link('extension/sms', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $file = array();
        if (isset($this->request->get['case_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $case_info = $this->model_extension_sms->getCase($this->request->get['case_id']);
            $case_images = $this->model_extension_sms->getCaseImages($this->request->get['case_id']);
        ...
        $this->template = 'extension/sms_form.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
