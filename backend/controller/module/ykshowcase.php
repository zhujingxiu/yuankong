...
class ControllerModuleYkshowcase extends Controller {
    ...
    public function index() {   
        $this->language->load('module/ykshowcase');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->request->post['ykshowcase_module'][0]['banner_image'] =    $this->request->post['banner_image'];
            unset($this->request->post['banner_image']);
            
    
            $this->model_setting_setting->editSetting('ykshowcase', $this->request->post);        
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('module/ykshowcase', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );
        
        $this->data['action'] = $this->url->link('module/ykshowcase', 'token=' . $this->session->data['token'], 'SSL');
        ...
        if (isset($this->request->post['ykshowcase_module'])) {
            $this->data['modules'] = $this->request->post['ykshowcase_module'];
        } elseif ($this->config->get('ykshowcase_module')) { 
            $this->data['modules'] = $this->config->get('ykshowcase_module');
        }   
        ...
        $this->template = 'module/ykshowcase.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
    ...
    protected function validate() {
        if (!$this->user->hasPermission('modify', 'module/ykshowcase')) {
