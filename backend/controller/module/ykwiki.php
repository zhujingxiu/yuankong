...
class ControllerModuleYkwiki extends Controller {
    ...
    public function index() {   
        ...
        $this->language->load('module/ykwiki');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->model_setting_setting->editSetting('ykwiki', $this->request->post);     
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('module/ykwiki', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );
        
        $this->data['action'] = $this->url->link('module/ykwiki', 'token=' . $this->session->data['token'], 'SSL');
        
        $this->data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');
        
        $this->data['modules'] = array();
        
        if (isset($this->request->post['ykwiki_module'])) {
            $this->data['modules'] = $this->request->post['ykwiki_module'];
        ...
        $this->data['wiki_groups'] = $news_group;
        $this->data['wiki_groups'][] =  array('group_id'=> 0 ,'name'=> $this->language->get('text_wiki_help'));
    ...
    protected function validate() {
        if (!$this->user->hasPermission('modify', 'module/ykwiki')) {
