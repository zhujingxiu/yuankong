...
class ControllerShippingFlat extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['flat_area_geo_id'])) {
			$this->data['flat_area_geo_id'] = $this->request->post['flat_area_geo_id'];
		} else {
			$this->data['flat_area_geo_id'] = $this->config->get('flat_area_geo_id');
		}
