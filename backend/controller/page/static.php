<?php
class ControllerPageStatic extends Controller {
	private $error = array(); 
	 
	public function index() {   
		$this->language->load('page/page');

		$this->document->setTitle($this->language->get('title_static'));
		...
		$this->data['heading_title'] = $this->language->get('title_static');
		...
		$this->data['tab_module'] = $this->language->get('tab_module');
 		...
 		if (isset($this->error['warning'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('title_static'),
			'href'      => $this->url->link('page/static', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('page/static', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['page'])) {
			...
			$this->data['modules'] = $this->model_setting_setting->getPages('static');
		}	
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'page/static')) {
