        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><textarea name="bank_transfer_bank_<?php echo $language['language_id']; ?>" cols="80" rows="10"><?php echo isset(${'bank_transfer_bank_' . $language['language_id']}) ? ${'bank_transfer_bank_' . $language['language_id']} : ''; ?></textarea>
              <img src="<?php echo TPL_IMG?>flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
          ...
          <tr>
            ...
            <td><select name="bank_transfer_area_geo_id">
                <option value="0"><?php echo $text_all_zones; ?></option>
                <?php foreach ($area_geos as $area_geo) { ?>
                <?php if ($area_geo['area_geo_id'] == $bank_transfer_area_geo_id) { ?>
