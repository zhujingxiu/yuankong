          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'c.title') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $column_logo; ?></td>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($item['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $item['express_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $item['express_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $item['title']; ?></td>
              <td class="left"><?php echo $item['logo'] ? '<img src="'.$item['logo'].'">' : '' ; ?></td>
