    ...
    <div>
      <table class="form">
        <tr>
          ...
          <td><select name="ykslideshow_module[<?php echo $module_row; ?>][layout_id]">
        ...
        <tr>
          ...
          <td><select name="ykslideshow_module[<?php echo $module_row; ?>][position]">
        ...
        <tr>
          ...
          <td><select name="ykslideshow_module[<?php echo $module_row; ?>][status]">
        ...
        <tr>
          ...
          <td><input type="text" name="ykslideshow_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="8" /></td>
        </tr>
        <tr>
          <td><?php echo $entry_height; ?></td>
          <td><input type="text" name="ykslideshow_module[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" size="8" /></td>
        </tr>
        
        <tr>
          <td><?php echo $entry_sort_order; ?></td>
          <td><input type="text" name="ykslideshow_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
        </tr>
      </table>
    </div>
    <h3><?php echo $entry_list_banner ?></h3>
        <div class="vtabs">
...
function addModule() {  
  ...
  html += '<table class="form"><tr><td><?php echo $entry_image ?></td><td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + banner_row + '" /><input type="hidden" name="banner_image[' + banner_row + '][image]" value="" id="image' + banner_row + '" /><br /><a onclick="image_upload(\'image' + banner_row + '\', \'thumb' + banner_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + banner_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + banner_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
  html += '<tr><td><?php echo $entry_link ?></td><td><input name="banner_image['+banner_row+'][link]" type="text" value=""/></td></tr>';
  html += '</table>';
  <?php foreach ($languages as $language) { ?>
