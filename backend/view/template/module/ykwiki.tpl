  ...
  <div class="box">
    ...
    <table class="form">
      ...
      <tr>
        ...
        <td><select name="ykwiki_module[<?php echo $module_row; ?>][layout_id]">
      ...
      <tr>
        ...
        <td><select name="ykwiki_module[<?php echo $module_row; ?>][position]">
      ...
      <tr>
        ...
        <td><select name="ykwiki_module[<?php echo $module_row; ?>][status]">
      ...
      <tr>
        ...
        <td><input type="text" name="ykwiki_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
      </tr>
    </table>
           ...
           <table class="form category-tab" id="category-tab-wrapper<?php echo $idx+1;?>">
              <tr>
                ...
                <td colspan="2">
                  ...
                  <select name="ykwiki_module[<?php echo $module_row;?>][category_tabs][]">
                   <?php foreach( $wiki_groups as $item){ ?>
                ...
                <td>
                    <input type="text" name="ykwiki_module[<?php echo $module_row;?>][limit][]" value="<?php echo $module['limit'][$idx];?>" size="3">
                </td>
                ...
                <input type="hidden" name="ykwiki_module[<?php echo $module_row; ?>][image][]" value="<?php echo $image; ?>" id="image<?php echo $imgidx; ?>"  />
                <br />
                ...
                <td>
                    <input type="text" name="ykwiki_module[<?php echo $module_row;?>][sort][]" value="<?php echo $module['sort'][$idx];?>" size="3">
                </td>
...
<script type="text/javascript">
  ...
  function addCategoryTab( wrapper,mid ){
    ...
    var html  = '';
     ...
     html +=       ' <td colspan="2">';
     html += '<select name="ykwiki_module['+mid+'][category_tabs][]">';
     <?php foreach( $wiki_groups as $item){ ?>
     ...
     html += '<td><input type="text" name="ykwiki_module['+mid+'][limit][]" size="3"></td>';
     html += '<td>  <?php echo $this->language->get( 'entry_icon_image' );?> </td>';
     html += '<td> ';
     html += '<div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + banner_row + '" /><input type="hidden" name="ykwiki_module[' + mid + '][image][]" value="" id="image' + banner_row + '" /><br /><a onclick="image_upload(\'image' + banner_row + '\', \'thumb' + banner_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + banner_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + banner_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div>';
    
     html += ' </td>'; 

     html += '<td><?php echo $this->language->get("entry_sort_order");?></td>';
     html += '<td><input type="text" name="ykwiki_module['+mid+'][sort][]" size="3"></td>';
...
function addModule() {  
  ...
  html += '      <td><select name="ykwiki_module[' + module_row + '][layout_id]">';
  <?php foreach ($layouts as $layout) { ?>
  ...
  html += '      <td><select name="ykwiki_module[' + module_row + '][status]">';
  ...
  html += '      <td><input type="text" name="ykwiki_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
  html += '    </tr>';
  html += '  </table>'; 
