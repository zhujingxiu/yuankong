      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="left"><select name="wiki_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td class="left"><select name="wiki_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="left"><select name="wiki_module[<?php echo $module_row; ?>][status]">
...
function addModule() {  
    ...
    html += '  <tr>';
    html += '    <td class="left"><select name="wiki_module[' + module_row + '][layout_id]">';
    <?php foreach ($layouts as $layout) { ?>
    html += '      <option value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
    <?php } ?>
    html += '    </select></td>';
    html += '    <td class="left"><select name="wiki_module[' + module_row + '][position]">';
    html += '      <option value="content_top"><?php echo $text_content_top; ?></option>';
    html += '      <option value="content_bottom"><?php echo $text_content_bottom; ?></option>';
    html += '      <option value="column_left"><?php echo $text_column_left; ?></option>';
    html += '      <option value="column_right"><?php echo $text_column_right; ?></option>';
    html += '    </select></td>';
    html += '    <td class="left"><select name="wiki_module[' + module_row + '][status]">';
