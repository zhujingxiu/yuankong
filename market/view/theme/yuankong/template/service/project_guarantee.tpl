<?php echo $header; ?>
<div class="mt10 bz-bannerbox">
    <div class="w fix">
        <div class="l">
            <img src="asset/image/project/zt-pic8.jpg" />
        </div>
        <div class="r">
            <div class="zt-gcsq-dj">
                ...
                <div class="gcsq-style">
                    ...
                    <?php if ($groups): ?>                   
                    <dl class="chose-xm">
                        <dt class="c-xm-dt"><span>消防保障</span></dt>
                        <dd class="c-xm-dd">
...
<div class="b_f ptb">
    <div class="w ovh">
        <p><img src="asset/image/project/ztpic22.jpg" /></p>
    </div>
</div>
<div class="zt-secbox">
    <div class="w ovh">
        <p><img src="asset/image/project/ztpic23.jpg" /></p>
    </div>
</div>
<div class="b_f ptb">
    <div class="w ovh">
        <p><img src="asset/image/project/ztpic24.jpg" /></p>
    </div>
</div>
<div class="w1000">
