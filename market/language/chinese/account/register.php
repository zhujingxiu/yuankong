...
$_['text_customer_phone']  		= '手机号码';
$_['text_company_name']   	= '请填写营业执照上的单位名称';
$_['text_company_email']   	= '填写企业邮箱';
...
$_['entry_company_telephone']   = '联系电话：';
$_['entry_company_name']  		= '单位名称：';
$_['entry_company_customer'] 	= '联系人姓名：';
$_['entry_company_company']		= '单位名称：';
$_['entry_company_group']		= '公司项目:';
$_['entry_company_address']		= '单位地址：';
$_['entry_city']           		= '所在城市：';
...
$_['error_sms_time']       = '手机验证码申请太过频繁，请稍后再试或尝试使用已发送的最近一条手机验证码！';
$_['error_sms']   	       = '输入的短信验证码无效';
$_['error_fullname']       = '姓名必须在1到32字符之间！';
