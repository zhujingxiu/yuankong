...
class ControllerPaymentPPProIframe extends Controller {
    ...
    public function create() {
        ...
        if (file_exists(DIR_APPLICATION . 'view/theme/' . $this->config->get('config_template') . '/stylesheet/stylesheet.css')) {
            $this->data['stylesheet'] = '/market/view/theme/' . $this->config->get('config_template') . '/stylesheet/stylesheet.css';
        } else {
            $this->data['stylesheet'] = '/market/view/theme/default/stylesheet/stylesheet.css';
        }
