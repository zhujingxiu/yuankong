...
class ControllerModuleYkproducts extends Controller {
    protected function index($setting) {
        ...
        if (file_exists('market/view/theme/' . $this->config->get('config_template') . '/stylesheet/ykproducts.css')) {
            $this->document->addStyle('market/view/theme/' . $this->config->get('config_template') . '/stylesheet/ykproducts.css');
        } else {
            $this->document->addStyle('market/view/theme/default/stylesheet/ykproducts.css');
        }
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/ykproducts.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/module/ykproducts.tpl';
        } else {
            $this->template = 'default/template/module/ykproducts.tpl';
        }
