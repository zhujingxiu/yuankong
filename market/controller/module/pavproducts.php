...
class ControllerModulepavproducts extends Controller {
	protected function index($setting) {
		...
		if (file_exists('market/view/theme/' . $this->config->get('config_template') . '/stylesheet/pavproducts.css')) {
			$this->document->addStyle('market/view/theme/' . $this->config->get('config_template') . '/stylesheet/pavproducts.css');
		} else {
			$this->document->addStyle('market/view/theme/default/stylesheet/pavproducts.css');
		}
