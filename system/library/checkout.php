...
class Checkout {
    ...
    public function __construct($registry) {
        ...
        if (!isset($this->session->data['checkout']) || !is_array($this->session->data['checkout'])) {
        ...
        if (!$this->data) {
            foreach ($this->session->data['checkout'] as $key => $quantity) {
                ...
                if ($product_query->num_rows) {
                    ...
                    foreach ($this->session->data['checkout'] as $key_2 => $quantity_2) {
    ...
    public function update($key, $qty) {
        ...
        if ((int)$qty && ((int)$qty > 0) && isset($this->session->data['checkout'][$key])) {
            $this->session->data['checkout'][$key] = (int)$qty;
        } else {
            $this->remove($key);
        }
    ...
    public function hasProducts() {
        ...
        return count($this->session->data['checkout']);
    }
