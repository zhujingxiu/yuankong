...
$alipay_config['partner'] = trim($config->get('alipay_direct_partner_id'));

//echo '111'.$config->get('alipay_direct_partner_id');exit;

//收款支付宝账号
$alipay_config['seller_email']	= trim($config->get('alipay_direct_account'));
