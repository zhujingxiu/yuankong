...
INSERT INTO `yk_wiki` (`wiki_id`, `group_id`, `user_id`, `title`, `subtitle`, `text`, `status`, `is_top`, `from`, `sort_order`, `date_added`) VALUES
...
INSERT INTO `yk_wiki_group` (`group_id`, `name`, `show`, `sort_order`) VALUES
(1, '消防法规', 0, 1),
(2, '消防新闻', 0, 2),
(3, '官方公告', 0, 3),
(4, '消防知识', 0, 4),
